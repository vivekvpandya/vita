...
int main(int argc , char** argv){
    ...
    if(world_rank <= num_groups){
    	// editors task
    	printf("Inside Editor Reporters under %d %d\n",world_rank, reporter_count[world_rank - 1]);
        ...
        //TODO: Send the news items to the main editor for updation.
		...
		//printf("Here\n");
		//printf("WORLD RANK/SIZE: %d/%d \t ROW RANK/SIZE: %d/%d\n",    world_rank, world_size, rep_rank, repo_count);
